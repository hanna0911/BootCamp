...
<v-container>
  ...
  <v-row>
    <h4 class="px-4 pt-4 pb-3 font-weight-black" style="margin-left: 12px">选择方法</h4>
    ...
    <v-card-text style="wrap-content">
      <el-form :inline="true" :model="formInline" class="demo-form-inline" style="margin-left: 30px; margin-top: 30px" v-if="assign_option=='list'">
          ...
          <el-form-item label="直属上级:" style="margin-left: 1.5%; margin-right: 1%" size="medium">
              ...
              <el-option label="全部" value="全部"></el-option>
              <el-option label="上级A" value="上级A"></el-option>
              <el-option label="上级B" value="上级B"></el-option>
              </el-select>
          </el-form-item>
      </el-form>
      <el-form :inline="true" :model="formInline" class="demo-form-inline" style="margin-left: 30px" v-if="assign_option=='list'">
          ...
          <el-form-item label="导师分配:" style="margin-left: 1.5%; margin-right: 1%" size="medium">
              ...
              <el-option label="全部" value="全部"></el-option>
              <el-option label="导师A" value="导师A"></el-option>
              <el-option label="导师B" value="导师B"></el-option>
              </el-select>
          </el-form-item>
      </el-form>
      <el-form :inline="true" :model="formInline" class="demo-form-inline" style="margin-left: 30px" v-if="assign_option=='list'"> 
  ...
  <v-btn @click="handleSendGroupMessage" v-if="assign_option=='group'">
    发送
  </v-btn>
  <v-btn @click="resetGroupMessage" v-if="assign_option=='group'">
    取消
  </v-btn>
  <v-dialog
    ...
    <v-card>
      ...
      <v-card-text style="wrap-content">
        <el-form :model="toAddGroup" ref="toAddTest" label-width="100px">
          <el-form-item label="群组名称："  style="margin-top: 20px">
